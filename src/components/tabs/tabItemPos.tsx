...
import {
  gcVoucherRedemption,
  posGCReinstateInstateFields,
  posNeucoinsRedemption,
  posNeuCoinsReInstateFields,
  posVoucherReinstateFields,
} from './constants'
        ...
        try {
          voucherRedemptionData = await api.post(
            'voucher/redeem',
            {
              ...
              h_confirmation_number: formValues?.invoiceNumber,
              posBookingOrderRequest: {
                outletName: formValues?.outletName,
                invoiceAmount: formValues?.invoiceamount,
                invoiceNumber: formValues?.invoiceNumber,
      ...
      if (
        ...
        setApiResponseData([
          ...
          },
          {
            ...
            value: redeemNeucoinsData?.data?.pointsRedeemed,
          },
        ])
      }
    }
